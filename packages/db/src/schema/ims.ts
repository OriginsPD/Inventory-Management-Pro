...
export const deviceRelationships = pgTable(
  ...
  (table) => ({
    primaryDeviceIdIdx: index("device_relationships_primary_device_id_idx").on(
      table.primaryDeviceId,
    ),
    linkedDeviceIdIdx: index("device_relationships_linked_device_id_idx").on(
      table.linkedDeviceId,
    ),
    uniqueRelIdx: index("device_relationships_unique_idx").on(
      table.primaryDeviceId,
      table.linkedDeviceId,
    ),
  }),
...
export const deviceAuditLogs = pgTable(
  ...
  (table) => ({
    ...
    deviceIdentifierIdx: index("device_audit_logs_device_identifier_idx").on(
