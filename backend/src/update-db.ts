...
async function run() {
  ...
  try {
    ...
    // 3. Ensure Better Auth text IDs can be generated by default.
    ...
    // 4. Add user_id column to device_audit_logs if it doesn't exist
    ...
    // 5. Add index for user_id on device_audit_logs
    ...
    // 7. Create index for device_id on qc_reports
